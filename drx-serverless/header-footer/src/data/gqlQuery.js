  ...
  const query = `
    query getItem($path: String!, $language: String) {
      item(path: $path, language: $language) {
        ...
        languageText: field(name: "languageText") {
          value
        }

        countryFlag: field(name: "countryFlag") {
          value
        }

        languageList: field(name: "languageList") {
          ... on MultilistField {
          links: targetItems {
              name: displayName
        ...
        showProfileLogo: field(name: "showProfileLogo") {
          ... on CheckboxField {
            value: boolValue
          }
        }

        showGivenNameLast: field(name: "showGivenNameLast") {
          ... on CheckboxField {
            value: boolValue
          }
        }

        showLanguageSelector: field(name: "showLanguageSelector") {
          ... on CheckboxField {
            value: boolValue
          }
        }
