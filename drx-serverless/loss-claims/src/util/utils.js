...
function isIfu(url) {
  ...
  var pattern =
    /^https:\/\/mss-p-007-delivery\.stylelabs\.cloud\/api\/public\/content\/[A-Z0-9_]+_[0-9]{1,2}_[0-9]{4}-[0-9]{2}-[0-9]{2}\?v=[a-z0-9]+$/;
...
function getDocumentNumber(url) {
  ...
  var pattern =
    /\/([A-Z0-9_]+)_[0-9]{1,2}_[0-9]{4}-[0-9]{2}-[0-9]{2}\?v=[a-z0-9]+$/;
