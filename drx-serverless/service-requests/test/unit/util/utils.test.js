...
describe('SUITE: utils', () => {
  ...
  describe('SUITE: utils convertIdsToString', () => {
    it('CASE: should convert the ids to strings', () => {
      const input = [
        {id: 1, name: 'John'},
        {id: 2, name: 'Jane'},
        {id: 3, name: 'Bob'}
      ...
      const result = utils.convertIdsToString(input);

      expect(result).to.deep.equal(expectedOutput);
    });

    it('CASE: should not modify the objects without id property', () => {
      const input = [
        {name: 'John'},
        {id: 2, name: 'Jane'},
        {id: 3, name: 'Bob'}
    ...
    it('CASE: should not modify the objects with id property already as string', () => {
      const input = [
        {id: '1', name: 'John'},
        {id: '2', name: 'Jane'},
        {id: '3', name: 'Bob'}
  ...
  describe('SUITE: utils convertIdsToNumber', () => {
    it('CASE: should convert the ids to numbers', () => {
      const input = [
        {id: '1', name: 'John'},
        {id: '2', name: 'Jane'},
        {id: '3', name: 'Bob'}
      ...
      const result = utils.convertIdsToNumber(input);

      expect(result).to.deep.equal(expectedOutput);
    });

    it('CASE: should not modify the objects with id property already as number', () => {
      const input = [
        {id: 1, name: 'John'},
        {id: 2, name: 'Jane'},
        {id: 3, name: 'Bob'}
    ...
    it('CASE: should handle an empty array input', () => {
      const input = [];
