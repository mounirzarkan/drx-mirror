...
const componentFactoryPath = path.resolve(
...
const componentRootPaths = [
  ...
  'src/components/AdaptiveForm2',
  'src/components/Equipment',
  'src/components/Containers',
  'src/components/SecurityAndPrivacy',
  'src/components/ServiceRequests',
  'src/components/IframeContainer'
];
...
function watchComponentFactory() {
  console.log(
    `Watching for changes to component factory sources in ${componentRootPaths[0]}, ${componentRootPaths[1]},  ${componentRootPaths[2]} and ${componentRootPaths[3]}`,
  );

  componentRootPaths.map(componentRootPath => {
    chokidar
